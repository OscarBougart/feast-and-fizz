  ...
  return (
    <div className="fixed z-39 w-96 h-20 max-w-lg -translate-x-1/2 rounded bottom-0 left-1/2 bg-farbnav">
      <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
        {/* Button Template */}
        {[
          { key: 'favorites', onClick: onFavorites, icon: (
            <svg width="40px" height="40px" viewBox="0 0 24 24" fill="currentColor">
              <path d="M5.65517 2.22732C5.2225 2.34037 4.9438 2.50021 4.72718 2.71244C4.42179 3.01165 4.22268 3.43172 4.11382 4.225C4.00176 5.04159 4 6.12387 4 7.67568V16.2442C4.38867 15.9781 4.82674 15.7756 5.29899 15.6517C5.41296 15.6217 5.53103 15.5983 5.65517 15.5799V2.22732Z" />
              <path d="M7.31034 15.5135L20 15.5135V7.67568C20 6.12387 19.9982 5.04159 19.8862 4.22499C19.7773 3.43172 19.5782 3.01165 19.2728 2.71244C18.9674 2.41324 18.5387 2.21816 17.729 2.11151C16.8955 2.00172 15.7908 2 14.2069 2H9.7931C8.79138 2 7.98133 2.00069 7.31034 2.02897V15.5135Z" />
          ...
          { key: 'food', onClick: onFood, icon: (
            <svg width="40px" height="40px" viewBox="0 0 122.88 122.88" fill="currentColor">
              <path d="M29.03,100.46l20.79-25.21l9.51,12.13L41,110.69C33.98,119.61,20.99,110.21,29.03,100.46Z M53.31,43.05c1.98-6.46,1.07-11.98-6.37-20.18L28.76,1c-2.58-3.03-8.66,1.42-6.12,5.09L37.18,24c2.75,3.34-2.36,7.76-5.2,4.32L16.94,9.8c-2.8-3.21-8.59,1.03-5.66,4.7c4.24,5.1,10.8,13.43,15.04,18.53c2.94,2.99-1.53,7.42-4.43,3.69L6.96,18.32c-2.19-2.38-5.77-0.9-6.72,1.88c-1.02,2.97,1.49,5.14,3.2,7.34L20.1,49.06c5.17,5.99,10.95,9.54,17.67,7.53c1.03-0.31,2.29-0.94,3.64-1.77l44.76,57.78c2.41,3.11,7.06,3.44,10.08,0.93l0.69-0.57c3.4-2.83,3.95-8,1.04-11.34L50.58,47.16C51.96,45.62,52.97,44.16,53.31,43.05z M65.98,55.65l7.37-8.94C63.87,23.21,99-8.11,116.03,6.29C136.72,23.8,105.97,66,84.36,55.57l-8.73,11.09L65.98,55.65z"/>
            </svg>
          )},
          { key: 'cocktail', onClick: onCocktails, icon: (
            <svg width="40px" height="40px" viewBox="0 0 576 576" fill="currentColor">
          ...
          { key: 'search', onClick: onSearch, icon: (
