...
function App() {
  ...
  const handleCocktails = () => setPage('cocktails');
        ...
        <div className="overflow-hidden h-screen flex flex-col">
          ...
          <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 rounded-full bottom-4 left-1/2 dark:bg-farb4 dark:border-gray-600">
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
              ...
              <button onClick={handleSearch} className="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
